...
<tr height=50>
   <td align=center>
     <?=$input_password?> 
     <br> <input type=image src=<?=$dir?>/i_confirm.gif border=0 onfocus="this.blur()">
    <a href=javascript:void(history.back())><img src=<?=$dir?>/i_back.gif border=0 onfocus="this.blur()"></a>
   </td>
</tr>
</table>
</form>
