...
<tr height=30>
  <td colspan=2 align=right>
     <input type=image align=absmiddle border=0 src=<?=$dir?>/images/btn_confirm.gif> <?=$a_list?><img src=<?=$dir?>/images/btn_list.gif border=0 align=absmiddle></a> <a href=javascript onclick=history.back()><img src=<?=$dir?>/images/btn_back.gif align=absmiddle border=0></a>
  </td>
</tr>
</table>
