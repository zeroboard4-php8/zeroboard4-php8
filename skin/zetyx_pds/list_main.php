      ...
      <tr>
         <td valign="top"> 
           ...
           <tr> 
             ...
             &nbsp;&nbsp;&nbsp;<b><?=$hide_category_start?>[<?=$category_name?>]<?=$hide_category_end?></b> <?=stripslashes($data['subject'])?></td>
           </tr>
<?php
 if($sitelink1)
 {
...
?>
           <tr>
             <td style="font-family:Arial;font-size:7pt;font-weight:bold;">&nbsp;&nbsp;
             Download : <?=$a_file_link1?><?=$data[s_file_name1]?></a> (Size : <?=$file_size1?>, Download : <?=$file_download1?>)</td>
           </tr>
