...
<STYLE TYPE="text/css">
<!--
.charlie-thm8 {font-family:Tahoma;font-size:8pt}
.charlie-thm7 {font-family:Tahoma;font-size:7pt;}
.charlie-thm6 {font-family:Tahoma;font-size:6pt;}
.charlie-input {border:0; background:transparent; font-family:Tahoma;font-size:8pt;color:#999999;width:60px;height:16px;line-height:100%; border-width:1; border-color:#000000; border-style:solid;'}
-->
</STYLE>
<!-- 마무리 부분입니다 -->
<tr>
...
<tr>
 <td colspan=2 align=center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <input type=text bgcolor=transparent name=keyword class=charlie-input><input type=image border=0 align=absmiddle src=<?=$dir?>/images/search_isearch.gif><?=$a_cancel?><img src=<?=$dir?>/images/search_icancel.gif align=absmiddle border=0></a>
 </td>
</form>
</tr>
