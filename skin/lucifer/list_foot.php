...
<tr>
 <td colspan=2 align=center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <input type=text name=keyword class=input value="<?=$keyword?>" <?=size(15)?> class=input2><input type=image border=0 align=absmiddle src=<?=$dir?>/images/search_isearch.gif><?=$a_cancel?><img src=<?=$dir?>/images/search_icancel.gif align=absmiddle border=0></a>
 </td>
</form>
</tr>
