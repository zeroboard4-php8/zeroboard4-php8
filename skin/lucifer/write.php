...
<tr height=25>
  <td align=right class=write><b>메일주소:&nbsp;</b></td>
...
<tr height=25>
  <td align=right class=write><b>홈페이지:&nbsp;</b></td>
...
<tr height=25>
  <td align=right class=write width=80><b>쓰기방식:&nbsp;</b></td>
  <td> 
  <table border=0 cellpadding=0 cellspacing=0>
  <tr>
  <td> 
<?=$category_kind?> 
  ...
  <td>
       <?=$hide_notice_start?> <input type=checkbox name=notice <?=$notice?> value=1></td><td class=write>&nbsp;공지사항 &nbsp;&nbsp;<?=$hide_notice_end?></td>
  <td>
       <?=$hide_html_start?> <input type=checkbox name=use_html <?=$use_html?> value=1></td><td class=write>&nbsp;html테그사용 &nbsp;&nbsp;<?=$hide_html_end?></td>
  <td>     <input type=checkbox name=reply_mail <?=$reply_mail?> value=1></td><td class=write>&nbsp;답변메일받기 &nbsp;&nbsp;</td>  
  <td>    <?=$hide_secret_start?> <input type=checkbox name=is_secret <?=$secret?> value=1></td><td class=write>&nbsp;비밀글 &nbsp;&nbsp;<?=$hide_secret_end?></td>
  </tr>
  </table>
  </td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr>
  <td align=right class=write><b>글의제목:&nbsp;</b></td>
  <td> <input type=text name=subject value="<?=$subject?>" <?=size(60)?> maxlength=200 class=input> </td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr>
  <td align=right class=write><b>글의내용:&nbsp;</b></td>
  <td valign=top>
  <textarea name=memo <?=size2(80)?> rows=6 class=textarea><?=$memo?></textarea>
  </td>
</tr>
...
<tr height=25>
  <td>&nbsp;</td>
  <td class=write><b>최고업로드사양: <?=$upload_limit?></b></td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
  <td align=right class=write><b>첫째파일:&nbsp;</b></td>
  <td> <input type=file name=file1 <?=size(50)?> maxlength=255 class=input> <?=$file_name1?></td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
  <td align=right class=write><b>둘?파일:&nbsp;</b></td>
