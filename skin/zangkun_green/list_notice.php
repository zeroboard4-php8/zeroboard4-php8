...
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  ...
  <td  colspan=2 align=left style='word-break:break-all;'>&nbsp; <?=$insert?> <img src=<?=$dir?>/notice_head.gif align=absmiddle>&nbsp;<?=$subject?> <font style=font-family:matchworks;font-size:8pt><?=$comment_num?></font></td> 
  <td nowrap><font color=666666 style=font-family:tahoma;font-size:9pt><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap><font color=666666 style=font-family:tahoma;font-size:7pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=666666 style=font-family:tahoma;font-size:7pt><?=$hit?></td>
</tr>
<tr><td colspan=7 background=<?=$dir?>/dot2.gif><img src=images/dot.gif height=1></td></tr>
