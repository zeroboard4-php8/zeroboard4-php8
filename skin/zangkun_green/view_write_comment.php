...
<input type=hidden name=mode value="<?=$mode?>">
 ...
 <td align=center>
   <img src=<?=$dir?>/cw_name.gif align="absmiddle"><?=$c_name?>     
   <img src=<?=$dir?>/cw_memo.gif align="absmiddle"><input type=text name=memo <?=size(20)?> maxlength=100 class=input>
   <?=$hide_c_password_start?>
   <img src=<?=$dir?>/cw_pass.gif align="absmiddle"><input type=password name=password <?=size(6)?> maxlength=20 class=input>
   <?=$hide_c_password_end?>
