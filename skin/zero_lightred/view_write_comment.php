...
<td>
  ...
  <table border=0 cellspacing=1 cellpadding=0 bgcolor=4E1B1C>
  <tr>
  <td  bgcolor=FEE9EA>

  <table border=0 cellpadding=5 cellspacing=1>
  <tr align=center style=font-size:9pt;font-family:굴림>
    <td width=80><font color=4E1B1C><b>이 &nbsp;&nbsp; 름</td>
    <td><font color=4E1B1C><b>내 &nbsp;&nbsp; 용</td>
    <?=$hide_c_password_start?><td><font color=4E1B1C><B>비밀번호</td><?=$hide_c_password_end?>
