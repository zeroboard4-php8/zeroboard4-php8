...
<input type=hidden name=mode value="<?=$mode?>">
 ...
 <tr>
  ...
  <td><img src=images/t.gif height=3><br><?=$c_name?>&nbsp;&nbsp;</td>
...
<?=$hide_c_password_end?>
  <td><img src=images/t.gif height=3><br>&nbsp;<input type=image border=0 align=absmiddle src=<?=$dir?>/images/btn_confirm.gif></td>
  </tr>
  </table>
 </td>
</tr>
