...
<tr>
    <td height=15 width=3 background=<?=$dir?>/robintop_left.gif></td>
    <td background=<?=$dir?>/robintop_bg.gif><?php	if($mode=="reply") { echo "<img src=$dir/robin_title_reply.gif border=0 hspace=2>";}
	elseif($mode=="modify") { echo "<img src=$dir/robin_title_modify.gif border=0 hspace=2>"; }
	else { echo "<img src=$dir/robin_title_new.gif border=0 hspace=2>"; } ?></td>
	<td width=3 background=<?=$dir?>/robintop_right.gif></td>
</tr>
</table>
<table cellspacing=0 cellpadding=0 border=0 width=500 height=5>
<tr><td></td></tr>
</table>
<table border=0 width=500 cellspacing=5 cellpadding=0 class=robin_writeform>
...
<tr>
  ...
  <td><input type=password name=password <?=size(20)?> maxlength=20 class=robin_input></td>
</tr>
...
<tr>
  ...
  <td>
       <?=$category_kind?>
       <?=$hide_notice_start?> <input type=checkbox name=notice <?=$notice?> value=1>
      Notice 
      <?=$hide_notice_end?>
      <?=$hide_html_start?>
