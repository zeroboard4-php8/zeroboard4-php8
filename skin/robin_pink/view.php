...
<td background=<?=$dir?>/robintop_bg.gif><img src=<?=$dir?>/robin_title_view.gif></td>
...
<tr>
	...
	<td bgcolor=white><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td width=4></td><td><?=$face_image?>&nbsp;<?=$name?></td><td align=right class=zv3_small>(<?=$date?>, Hit : <b><?=$hit?></b>, Vote : <b><?=$vote?></b>)&nbsp;</td></tr></table></td>
</tr>
