...
<tr>
  <td height=23 nowrap style='padding:10 0 15 10'><?=$face_image?> <?=$name?>&nbsp;<font style='font-weight:normal'><?=$hide_homepage_start?> (<?=$a_homepage?><font style='font-family:tahoma;font-size:8pt'>homepage</font></a>)<?=$hide_homepage_end?>님께서 남기신 글</font>
  </td>
