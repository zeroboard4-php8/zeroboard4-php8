...
<tr align=center onMouseOver=this.style.backgroundColor='<?=$list_mouse_over_color?>' onMouseOut=this.style.backgroundColor=''>
  <td height=22 class=kissofgod-notice-td><img src=<?=$dir?>/icon_notice.gif width=18 height=9 border=0></td>
  <?=$hide_cart_start?>
  <td class=kissofgod-notice-td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <?=$hide_category_start?>
  <td align=left class=kissofgod-notice-td style='padding-left:10'><?=$category_name?></td><?=$hide_category_end?>
  <td align=left class=kissofgod-notice-td style='word-break:break-all;'><img src=images/t.gif border=0 width=1 height=3><br><?=$insert?><?=$icon?><?=$subject?> <font style='font-family:Tahoma;font-size:6pt'><?=$comment_num?></font></td> 
  <td align=left class=kissofgod-notice-td style='word-break:break-all;'><img src=images/t.gif border=0 width=1 height=3><br><?=$face_image?> <?=$name?></div></td>
  <td class=kissofgod-notice-td style='font-family:Tahoma;font-size:8pt'><?=$reg_date?></td>
  <td class=kissofgod-notice-td style='font-family:Tahoma;font-size:8pt'><?=$hit?></td>
</tr>
