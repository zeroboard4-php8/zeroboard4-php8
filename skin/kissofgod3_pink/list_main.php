...
<tr align=center onMouseOver=this.style.backgroundColor='<?=$list_mouse_over_color?>' onMouseOut=this.style.backgroundColor=''>
  <td height=22 style='font-family:Tahoma;font-size:8pt; padding:0 7'><?=$number?></td>
  <?=$hide_cart_start?>
  <td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <?=$hide_category_start?>
  <td align=left style='padding-left:10'><?=$category_name?></td><?=$hide_category_end?>
  <td align=left style='word-break:break-all;'><img src=images/t.gif border=0 width=1 height=3><br><?=$insert?><?=$icon?><?=$subject?> <font style='font-family:Tahoma;font-size:6pt'><?=$comment_num?></font></td> 
  <td align=left style='word-break:break-all;'><img src=images/t.gif border=0 width=1 height=3><br><?=$face_image?> <?=$name?></div></td>
  <td style='font-family:Tahoma;font-size:8pt'><?=$reg_date?></td>
  <td style='font-family:Tahoma;font-size:8pt; padding:0 7'><?=$hit?></td>
</tr>
