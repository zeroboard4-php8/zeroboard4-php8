<tr>
	<td colspan=<?=$colspanNum?> bgcolor=#e6e6e6 height=2></td>
</tr>
<tr>
	<td colspan=<?=$colspanNum?> bgcolor=#555555 height=2></td>
</tr>
</table>
<table border=0 cellspacing=0 cellpadding=0 width=<?=$width?> height=2>
<tr>
	<td height=2 class=robin_footer><img src=<?=$dir?>/t.gif border=0 height=2></td>
</tr>
</table>
