...
<table border=0 width=<?=$width?> height=22 cellsapcing=0 cellpadding=0 cellspacing=0>
  <tr> 
    <td width=6 background=<?=$dir?>/top_left.gif></td>
    <td background=<?=$dir?>/robinweb_topbar.gif><img src=<?=$dir?>/t.gif border=0 height=17></td>
	<td width=6 background=<?=$dir?>/top_right.gif></td>
  </tr>
</table>
