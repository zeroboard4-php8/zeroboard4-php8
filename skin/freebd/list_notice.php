...
<tr height=20 align=center bgcolor='<?=$list_notice_bg?>' onmouseover="this.style.backgroundColor='<?=$list_notice_over_bg?>'" onmouseout="this.style.backgroundColor=''">

  <td></td>

  <td style='padding:0 5'><img src=<?=$dir?>/notice_head.gif width=15 height=15></td>

<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>

  <td align=left style='word-break:break-all;'><?=$insert?><img width=1 height=1>&nbsp;<?=$subject?> <font class=thm6><?=$comment_num?></b></td>
...
<tr>
  <td height=1 bgcolor='<?=$list_notice_line?>' colspan=10><img height=1></td>
</tr>
