    ...
    <div id="content">
        ...
        <div id="swuInfoContain">
            ...
            <div id="download_guide">
              <?php 
              if($_SS['upload_number']) $_strSkin['up_size'] = str_replace('[count]','<font class=han2>'.$_SS['upload_number'].'</font>',$_strSkin['up_size']);
              ...
              <?php if(!$_SS['using_imageUpOnly']) echo '<br />'.$_strSkin['download_guide']?>
            </div>
            </div>
