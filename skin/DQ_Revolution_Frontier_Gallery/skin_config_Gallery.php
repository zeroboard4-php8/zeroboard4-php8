...
?>
	<IFRAME name=get_css scrolling=no frameborder=0 width=0 height=0 src="get_cssconfig.php?id=<?=$skin_setup['css_dir']?>&mode=css">
	</IFRAME>
	<table width="100%" height="100%"  border="0" cellpadding="5" cellspacing="0" class=info_bg>
	  <form action="<?=basename($_SERVER['PHP_SELF'])."?id=$id&mode=write&pos=$pos"?>" onSubmit="javascript:getScroll_pos()" method="post" enctype="multipart/form-data" name="config" id="config">
	  <input type=hidden name=pos id=pos value=<?=!empty($pos)?$pos:'0'?>>
	  <input type=hidden name=gd_version id=gd_version value=<?=$gd_version?>>
	  <tr>
		<td valign="top" class="info_bg" style="padding:5px;">
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td height=35 class="line2" style="font-size:13pt;font-weight:bold;">&nbsp;&nbsp;레/볼/루/션/ 환경설정 ver 1.4</td>
		  </tr>
		  <tr>
		    <td class=line2 style="padding:5px">
              ...
              <tr>
                ...
                <td>:
					...
					<?php if(get_gdVersion()<2) echo "&nbsp;&nbsp;GD 1.x 버전은 썸네일 퀄리티가 좋지 않습니다. 썸네일에서 보이는 계단현상은 정상입니다."?>
				</td>
              </tr>
              <tr>
                <td height="18" align="right"><b>스킨버전</b></td>
                <td>:
                    <?=$dqrevolutionType.' '.$skin_version?></td>
              </tr>
              <tr>
	 ...
	 while ($cfg_file = readdir($handle)) {
	   if(substr($cfg_file,0,4)=="cfg_" && $cfg_file!="cfg_$id".".php") {
		 ...
		 for($i=0; $i<=count($ftmp); $i++) {
			 if(!empty($ftmp[$i]) && eregi("cfg_linkFile",$ftmp[$i])) {
				 $is_linkCfg = true;
				 break;
			 }
		 }
		 ...
		 if(!$is_linkCfg) {
			 if(isset($cfg_linkFile) && $cfg_file==$cfg_linkFile) {
				 $select=" selected";
				 $cfg_linkCheck = true;
			 } else $select="";
                ...
                <td valign="top" style="padding:2px;">
				  ...
				  <table width="100%"  border="0" cellpadding="3" cellspacing="0">
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>세로 정렬 </td>
                      <td><input type="radio" name="thumb_valign" value="top"<?php if($skin_setup['thumb_valign']=="top") echo " checked"?>>
                        위
                          <input type="radio" name="thumb_valign" value="middle"<?php if($skin_setup['thumb_valign']=="middle") echo " checked"?>>
                          가운데
                          <input type="radio" name="thumb_valign" value="bottom"<?php if($skin_setup['thumb_valign']=="bottom") echo " checked"?>>
                          아래</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
...
<input type="radio" name="thumb_resize" value="2"<?php if($skin_setup['thumb_resize']=="2") echo " checked"?>>원본비율 유지하면서 Crop </td>
                    ...
                    <tr>
                      <td><input name="using_usm" type="checkbox" id="using_usm" value="1"<?php if(!empty($skin_setup['using_usm'])) echo " checked"?><?=draw_usm(0)?>></td>
		  ...
		  <tr>
		    <td class="han2" style="padding:10px 5px 10px 5"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width=1 class=line1></td>
                <td valign="top" style="padding:2px;">
				  <div  onClick="showhide2(this,thumbinfo)" style="cursor:pointer;padding:0 0 5px 10px;">+ 게시물 목록의 썸네일 출력물의 하단 출력을 설정 </div>
                    <div id=thumbinfo style='display:<?=$tabshow?>'>
                      <table width="100%"  border="0" cellpadding="3" cellspacing="0">
                        ...
                        <col width="">
                        <tr>
                          <td><input name="show_thumbInfo" type="checkbox" id="show_thumbInfo" value="1"<?php if(!empty($skin_setup['show_thumbInfo'])) echo " checked"?>></td>
                          <td>섬네일 하단 정보 보여줌 </td>
		  ...
		  <tr>
		    <td class="han2" style="padding:10px 5px 10px 5"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
                ...
                <td width=1 class=line1></td>
                <td valign="top" style="padding:2px;">
				  <span  onClick="showhide2(this,body2)" style="cursor:pointer;padding:0 0 5px 10px;">+ 본문내용 볼때의 정렬, 리사이즈 등의 세부설정</span>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">
                      첨부된 사진이 <input name="slide_album_mode_value0" type="text" class="input" id="slide_album_mode_value0" value="<?=$skin_setup['slide_album_mode_value0']?>" size="4" maxlength="4">개 이상일 경우에만 슬라이드 앨범을 사용 [설정1]
                    </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">
                      첨부된 사진이 <input name="slide_album_mode_value1" type="text" class="input" id="slide_album_mode_value1" value="<?=$skin_setup['slide_album_mode_value1']?>" size="4" maxlength="4">개 이하일 경우 썸네일 리스트 아래에 미리보기 사용 <br />
                      <span class="descript">→ ([설정1] 보다 높게 설정하면 미리보기 기능을 끌 수 있습니다)</span>
                    </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">
                      썸네일 크기 : <input name="slide_album_mode_value2" type="text" class="input" id="slide_album_mode_value2" value="<?=$skin_setup['slide_album_mode_value2']?>" size="4" maxlength="4"> 픽셀 (가로x세로 Crop 이미지 생성)
                    </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">
                      <input type="checkbox" name="slide_album_mode_value3" value="1"<?php if(!empty($skin_setup['slide_album_mode_value3'])) echo " checked"?>> 페이지 로딩이 끝나면 자동으로 슬라이드쇼를 진행
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td colspan="2">
                      본문 보기시 이미지의 실제경로 숨김 기능을 사용하지 않음
                ...
                <td valign="top" style="padding:2px;">
                  ...
                  <tr>
                    ...
                    <td colspan="2" >파일 업로드 최대 갯수 :
                      <input name="upload_number" type="text" class="input" value="<?=$skin_setup['upload_number']?>" size="3" maxlength="4"> 개 <span class="descript">→ '0' 이면 무제한입니다.<?php if(empty($setup['use_pds'])){?><span style="color:red"> (사용 하시려면 게시판 설정에서 '자료실' 기능을 활성화 하세요)</span><?php } ?></span>
                      </td>
                  </tr>
                  <tr>
      ...
      분이 지나야 다음 게시물 등록 가능 </td>
                  ...
                  <tr>
                    <td><input name="using_secretonly" type="checkbox" id="using_secretonly" onClick="onoff_chk(this,inputPWD_mbSecretArticle)" value="1"<?php if(!empty($skin_setup['using_secretonly'])) echo " checked"?><?=draw_is_active()?>></td>
                    <td colspan="2">비밀글로만 등록 </td>
                  </tr>
                  <tr>
                    <td><input name="inputPWD_mbSecretArticle" type="checkbox" id="inputPWD_mbSecretArticle" onClick="onoff_chk(this,using_secretonly)" value="1"<?php if(!empty($skin_setup['inputPWD_mbSecretArticle'])) echo " checked"?><?=draw_is_active()?>></td>
                    <td colspan="2">
                    로그인한 상태에서 비밀글 작성시에도 비밀번호 입력받음<br />
                  ...
                  <tr>
                    ...
                    <td colspan="2">작성된 글을 관리자 이메일로 보내기<?=$strNewIcon?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><input type=hidden name=fckSkin_sel id=fckSkin_sel value="">
			  ...
			  <tr>
                ...
                <td valign="top" style="padding:2px;">
                  ...
                  <tr>
                    ...
                    <td colspan="2">작성한후
                      <input name="using_commentEditor2" type="text" class="input" id="using_commentEditor2" value="<?=!empty($skin_setup['using_commentEditor2'])?$skin_setup['using_commentEditor2']:''?>" size="3" maxlength="8"<?=draw_is_active()?>>분을 경과하지 않은 짧은답글은 수정할수 있음 </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td>추천 기능 사용 </td>
                    <td><div id=votetype<?php if(empty($skin_setup['using_vote'])) echo " style='display:none'"?>><input type="radio" name="vote_type" value="1"<?php if($skin_setup['vote_type']=="1") echo " checked"?>> 일반 추천
  ...
  <input type="radio" name="coment_select" value="2"<?php if(!empty($skin_setup['coment_select']) && $skin_setup['coment_select']=="2") echo " checked"?>> 글만남김</td>
                  ...
                  <tr>
                    ...
                    <td colspan="2">추천수가 
					  <input name="move_vote2" type="text" class="input" id="move_vote2" value="<?=!empty($skin_setup['move_vote2'])?$skin_setup['move_vote2']:''?>" size="4" maxlength="4"<?=draw_is_active()?>> 
                      이상이면 
...
?>
                      ...
                      <select name="move_vote4" id="move_vote4"<?=draw_is_active()?>>
                        <option value="copy_all"<?php if(!empty($skin_setup['move_vote4']) && $skin_setup['move_vote4']=='copy_all') echo " selected"?>>복사</option>
                        <option value="move_all"<?php if(!empty($skin_setup['move_vote4']) && $skin_setup['move_vote4']=='move_all') echo " selected"?>>이동</option>
                      </select></td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="2">추천에 의한 자동 복사/이동시 게시물 작성자에게 보너스 글쓰기 포인트 <input name="RecommentPointValue" type="text" class="input" id="RecommentPointValue" value="<?=!empty($skin_setup['RecommentPointValue'])?$skin_setup['RecommentPointValue']:''?>" size="2" maxlength="2"<?=draw_is_active()?>>점 주기<br />
                    <span class="han2">*주의! 자동 복사/이동 설정된 게시판으로 관리자 임의의 복사/이동시에도 보너스 포인트 적용됩니다.</span>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="2">계층형 코멘트(일명 댓글에 댓글달기) 사용<?=$strNewIcon?></td>
                  </tr>
                  <tr>
		    ...
		    <td class="han2" style="padding:10px 5px 10px 5"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
                ...
                <td valign="top" style="padding:2px;">
                  ...
                  <col width="">
                  <tr>
                    <td><input name="using_pageNumber" type="checkbox" id="using_pageNumber" value="1"<?php if(!empty($skin_setup['using_pageNumber'])) echo " checked"?>></td>
                    <td>페이지 번호 사용 </td>
                    <td>정렬방법:
      ...
      오른쪽</td>
                  ...
                  <tr>
                    <td><input name="using_pageNavi" type="checkbox" id="using_pageNavi" value="1"<?php if(!empty($skin_setup['using_pageNavi'])) echo " checked"?>></td>
                    <td>페이지 이동버튼 사용 </td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td><input name="using_search" type="checkbox" id="using_search" value="1"<?php if(!empty($skin_setup['using_search'])) echo " checked"?>></td>
                    <td colspan="2">검색창 사용 </td>
                  </tr>
                  <tr>
                    <td><input name="disable_login" type="checkbox" id="disable_login" value="1"<?php if(!empty($skin_setup['disable_login'])) echo " checked"?>></td>
                    <td colspan="2">로그인/회원가입/메모 버튼 숨김</td>
                  </tr>
                  <tr>
                    <td><input name="using_category" type="checkbox" id="using_category" value="1"<?php if(!empty($skin_setup['using_category'])) echo " checked"?>></td>
                    <td>카테고리 출력함</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
      ...
      개 이상이면 다음줄로 넘어감 </td>
                  ...
                  <tr>
                    <td><input name="using_sort" type="checkbox" id="using_sort" value="1"<?php if(($skin_setup['using_sort'])) echo " checked"?>></td>
                    <td>정렬옵션 사용 </td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="2">썸네일 클릭시 라이트박스로 원본 이미지 보여줌</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox" name="using_siteLink" value="1"<?php if(!empty($skin_setup['using_siteLink'])) echo " checked"?>></td>
                    <td colspan="2">썸네일형 링크 게시판으로 사용(썸네일 하단을 깨끗이 정리 하셔야 보기에 좋습니다.)</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">&nbsp;</td>
			  ...
			  <tr>
                ...
                <td valign="top" style="padding:2px;">
                  ...
                  <tr>
                    ...
                    <td><textarea name="write_guide" cols="100" rows="5" wrap="VIRTUAL" class="textarea" style="width:99%"><?=!empty($skin_setup['write_guide'])?trim(stripslashes($skin_setup['write_guide'])):''?></textarea></td>
                  </tr>
                  <tr>
                    ...
                    <td><textarea name="write_agreement" cols="100" rows="5" wrap="VIRTUAL" class="textarea" style="width:99%"><?=!empty($skin_setup['write_agreement'])?trim(stripslashes($skin_setup['write_agreement'])):''?></textarea></td>
                  </tr>
                  <tr>
                    <td colspan="2">코멘트 제한 안내<br>(코멘트 레벨제한시)</td>
                    <td><textarea name="comment_grant_guide" cols="100" rows="2" class="textarea" style="width:99%"><?=!empty($skin_setup['comment_grant_guide'])?trim(stripslashes($skin_setup['comment_grant_guide'])):''?></textarea></td>
                  </tr>
                  <tr>
                    <td colspan="2">코멘트 달기 안내 </td>
                    <td><textarea name="comment_guide" cols="100" rows="2" class="textarea" style="width:99%"><?=!empty($skin_setup['comment_guide'])?trim(stripslashes($skin_setup['comment_guide'])):''?></textarea></td>
                  </tr>
                  <tr>
...
if($mode == "write") {
	...
	if(!empty($_POST['board_bgColor'])) 
		@zb_query("update zetyx_admin_table set bg_color='{$_POST['board_bgColor']}' where no='$setup[no]'") or die(zb_error());
	if(!empty($_POST['thumb_vcount'])) {
		$thumb_total = $_POST['thumb_hcount']*$_POST['thumb_vcount'];
		@zb_query("update zetyx_admin_table set memo_num='$thumb_total' where no='$setup[no]'") or die(zb_error());
	}
	if(!empty($_POST['grant_html'])) 
		@zb_query("update zetyx_admin_table set grant_html='{$_POST['grant_html']}' where no='$setup[no]'") or die(zb_error());
	if(!empty($_POST['using_siteLink'])) 
		@zb_query("update zetyx_admin_table set use_filelink='1' where no='$setup[no]'") or die(zb_error());
?>
