...
// 정렬버튼
	...
	if($select_arrange=="hit") $bt_hit = $a_hit."<b class=han>조회순</b></a>"; else $bt_hit = $a_hit."<font class=han>조회순</font></a>";
	if($select_arrange=="vote") $bt_vote = $a_vote."<b class=han>추천순</b></a>"; else $bt_vote = $a_vote."<font class=han>추천순</font></a>";
	if($select_arrange=="reg_date") $bt_date = $a_date."<b class=han>날짜순</b></a>"; else $bt_date = $a_date."<font class=han>날짜순</font></a>";

	$bt_sort = "<nobr>$bt_no | $bt_date | $bt_hit | $bt_vote</nobr>";
