...
//---- option ----------------------------------
	...
	$_leftframe_width = '100';


//---- text ----------------------------------


	$_strSkin['title']		= '새로운 사진 등록';
	...
	$_strSkin['subject']	= '제목';
	$_strSkin['memo1']		= '상세설명';	// 업로드필드 아래에 "설명첨부"가 가능 할때
	$_strSkin['memo2']		= '사진설명';	// 업로드필드 아래에 "설명첨부"가 불가능 할때
	$_strSkin['bgm']		= '배경음악 링크';
	$_strSkin['file']		= '이미지 파일';
	...
	$_strSkin['up_size']	= '등록할수 있는 이미지파일 하나의 용량은 최대 [upload_size] 입니다.';
	$_strSkin['use_thumb']	= '섬네일로만 사용';
	$_strSkin['upfile_cnt']	= '업로드할 이미지 파일을 [upfile_cnt]개 더 추가 하실수 있습니다.';
