...
<td background=<?=$dir?>/images/head_bg.gif><?=$a_no?><font color=#ffffff>번호</font></a></td> 
<?=$hide_cart_start?><td background=<?=$dir?>/images/head_bg.gif><?=$a_cart?><font color=#ffffff>C</font></a></td><?=$hide_cart_end?> 
<td background=<?=$dir?>/images/head_bg.gif><?=$a_subject?><font color=#ffffff>제목</font></a></td>

<td align='<?=$head_name_align?>' background=<?=$dir?>/images/head_bg.gif><?=$a_name?><font color=#ffffff>작성자</font></a></td>
<td background=<?=$dir?>/images/head_bg.gif><?=$a_date?><font color=#ffffff>작성일</a></td>
<td background=<?=$dir?>/images/head_bg.gif><?=$a_hit?><font color=#ffffff>조회</font></a></td>
