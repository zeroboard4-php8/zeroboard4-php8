...
<?php
  if($mode=="reply") $title="<font color=#fffffff>&nbsp;답변달기</font>";
  elseif($mode=="modify") $title="<font color=#fffffff>&nbsp;수정하기</font>";
  else $title="<font color=#ffffff>새글쓰기 </font>";
?>
...
<tr>
  ...
  <tr>
	...
	<td height=33 background=<?=$dir?>/images/head_bg.gif><img width=10 height=1><?=$title?></td>
	<td width=1 bgcolor='<?=$head_border?>'><img width=1 height=13></td>
  </tr>
  </table>
  </td>
...
<tr width=100%>
  ...
  <td height=30 colspan=2 align=right style='padding-bottom:5'>
    ...
    <input type=image src=<?=$dir?>/images/i_confirm.gif style='width:66;height:26'><img width=10 height=1><a href=javascript:history.go(-1)><img src=<?=$dir?>/images/i_back.gif width=86 height=26 border=0></a></td>
