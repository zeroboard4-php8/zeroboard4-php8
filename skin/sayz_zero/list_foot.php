...
<tr>
  <td width=49%>
    <?=$a_list?><img src=<?=$dir?>/images/i_list.gif border=0></a>
	<?=$a_delete_all?><img src=<?=$dir?>/images/i_delete.gif border=0></a></td>
  <td align=center nowrap class=thm8>
<!-- 페이지 출력 ---------------------->
    <?=$a_prev_page?>[prev]</a> <?=$print_page?> <?=$a_next_page?>[next]</a>
  </td>
  <td align=right width=49%>
    <?=$a_write?><img src=<?=$dir?>/images/i_write.gif border=0></a>
  </td>
</tr>
</form></table>
...
<!----- 검색창 ----->
  ...
  <tr>
    ...
    <td width=57><input type=image src=<?=$dir?>/images/search.gif onfocus=blur() style='width:66;height:28'></td>
