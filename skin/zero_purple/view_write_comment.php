...
<td>
  ...
  <table border=0 cellspacing=1 cellpadding=0 bgcolor=8C4A7F>
  <tr>
  <td  bgcolor=FDEBF9>

  <table border=0 cellpadding=5 cellspacing=1>
  <tr align=center style=font-size:9pt;font-family:굴림>
    <td width=80><font color=8C4A7F><b>이 &nbsp;&nbsp; 름</td>
    <td><font color=8C4A7F><b>내 &nbsp;&nbsp; 용</td>
    <?=$hide_c_password_start?><td><font color=8C4A7F><B>비밀번호</td><?=$hide_c_password_end?>
