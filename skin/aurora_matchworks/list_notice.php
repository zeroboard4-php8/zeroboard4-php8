...
<tr align=center bgcolor=d3d3d3>
  <td nowrap><font color=gray style=font-family:굴림;font-size:9pt>ⓝ</td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>  <td nowrap><?=$face_image?><?=$name?>&nbsp;&nbsp;</div></td>  
  ...
  <td nowrap><font color=gray style=font-family:matchworks,tahoma;font-size:8pt><?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=gray style=font-family:matchworks,tahoma;font-size:8pt><?=$hit?></td>
</tr>
<tr><td height=1 colspan=6 background=<?=$dir?>/ndot.gif><img src=<?=$dir?>/ndot.gif border=0 height=1></td></tr>
