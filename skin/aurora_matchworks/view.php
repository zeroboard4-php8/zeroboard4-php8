...
<?=$hide_comment_start?> 
<table border=0 cellspacing=0 cellpadding=0 width=<?=$width?>>
<tr><Td height=1 background=<?=$dir?>/dot.gif border=0><img src=<?=$dir?>/dot.gif border=0 height=1></td></tr>
</table>
<table border=0 cellspacing=0 cellpadding=2 width=<?=$width?>>
<tr valign=top>
 <td><img src=<?=$dir?>/h_left.gif border=0><img src=<?=$dir?>/h_name.gif border=0><img src=<?=$dir?>/h_right.gif border=0></td>
 <td width=100%>&nbsp;&nbsp;<img src=<?=$dir?>/h_left.gif border=0><img src=<?=$dir?>/h_subject.gif border=0><img src=<?=$dir?>/h_right.gif border=0></td>
 <td><img src=<?=$dir?>/h_left.gif border=0><img src=<?=$dir?>/h_date.gif border=0><img src=<?=$dir?>/h_right.gif border=0></td>
 <td>&nbsp;</td>
</tr>
<?=$hide_comment_end?>
