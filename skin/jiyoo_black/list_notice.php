...
<tr align=center>
  <td height=20 class=write>&nbsp;<?=$icon?></td>
...
<?=$hide_category_start?><td><img src=images/t.gif height=3><br><?=$category_name?></td><?=$hide_category_end?>
  <td align=left style='word-break:break-all;'><img src=images/t.gif height=3><br><?=$insert?><?=$subject?> <font style=font-family:Tahoma;font-size:6pt;font-weight:bold;letter-spacing:-1px;><?=$comment_num?></font></td> 
...
<tr>
   <td colspan=10 background=<?=$dir?>/images/list_line_dot.gif><img src=images/t.gif height=1></td>
</tr>