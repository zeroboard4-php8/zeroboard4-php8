...
<?php 
  if($mode=="reply") $title='<font class=w_title>Post a Reply</font>';
  elseif($mode=="modify") $title="<font class=w_title>Modify Article</font>";
  else $title="<font class=w_title>Post a New Article</font>";
?>
...
<tr height=25>
  <td align=right class=write><b>E-mail&nbsp;</b></td>
...
<tr height=25>
  <td align=right class=write><b>Homepage&nbsp;</b></td>
...
<tr height=25>
  <td align=right class=write width=80><b>Special&nbsp;</b></td>
  <td> 
  <table border=0 cellpadding=0 cellspacing=0>
  <tr>
  <td> 
<?=$category_kind?> 
  ...
  <td>
       <?=$hide_notice_start?> <input type=checkbox name=notice <?=$notice?> value=1></td><td class=write>&nbsp;Notice &nbsp;&nbsp;<?=$hide_notice_end?></td>
  <td>
       <?=$hide_html_start?> <input type=checkbox name=use_html <?=$use_html?> value=1></td><td class=write>&nbsp;Use HTML &nbsp;&nbsp;<?=$hide_html_end?></td>
  <td>     <input type=checkbox name=reply_mail <?=$reply_mail?> value=1></td><td class=write>&nbsp;Reply Mail &nbsp;&nbsp;</td>  
  <td>    <?=$hide_secret_start?> <input type=checkbox name=is_secret <?=$secret?> value=1></td><td class=write>&nbsp;Secret &nbsp;&nbsp;<?=$hide_secret_end?></td>
  </tr>
  </table>
  </td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr>
  <td align=right class=write><b>Subject&nbsp;</b></td>
  <td> <input type=text name=subject value="<?=$subject?>" <?=size(60)?> maxlength=200 class=input> </td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr>
  <td align=right class=write><b>Contents&nbsp;</b></td>
  <td valign=top>
  <textarea name=memo <?=size2(80)?> rows=15 class=textarea><?=$memo?></textarea>
  </td>
</tr>
...
<tr height=25>
  <td align=right class=write><b>Link &nbsp;</b></td>
...
<tr height=25>
  <td>&nbsp;</td>
  <td class=write><b>Maximum File size : <?=$upload_limit?></b></td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
  <td align=right class=write><b>File #1&nbsp;</b></td>
  <td> <input type=file name=file1 <?=size(50)?> maxlength=255 class=input> <?=$file_name1?></td>
</tr>
<tr><td height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
  <td align=right class=write><b>File #2&nbsp;</b></td>
...
<tr align=center height=30>
  <td align=right>
      ...
      <img src=<?=$dir?>/images/i_wback.gif align=absmiddle border=0 style=cursor:hand onclick=history.back()>
  </td>
</tr>
</table>
