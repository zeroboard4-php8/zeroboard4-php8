...
<tr>
<td colspan=2 align=right><input type=image src=<?=$dir?>/images/i_confirm.gif><img width=10 height=1><a href=javascript:history.go(-1)><img src=<?=$dir?>/images/i_back.gif border=0 width=60 height=15></a></td>
</tr>
</table>