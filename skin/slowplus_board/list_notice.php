...
<tr height=22 align=center bgcolor='<?=$list_notice_bg?>' onmouseover="this.style.backgroundColor='<?=$list_notice_over_bg?>'" onmouseout="this.style.backgroundColor=''">

  <td></td>

  <td style='padding:0 5'><img src=<?=$dir?>/notice_head.gif width=11 height=11></td>

<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>

  <td align=left style='word-break:break-all;'><img width=1 height=3><br><?=$insert?><img width=1 height=1>&nbsp;<?=$subject?> <font class=thm6><?=$comment_num?></b></td>
