...
<tr align=center  bgcolor="#EFEFEF" onMouseOver=this.style.backgroundColor="#FFFFFF" onMouseOut=this.style.backgroundColor="#EFEFEF">
  <td nowrap><font color=444444 style=font-family:verdana,tahoma;font-size:7pt>notice</td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'>&nbsp; <?=$insert?> <img src=<?=$dir?>/notice_head.gif align=absmiddle>&nbsp;<?=$subject?> <font style=font-family:matchworks;font-size:8pt><?=$comment_num?></font></td> 
  <td nowrap><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap><font color=444444 style=font-family:verdana,tahoma;font-size:7pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=444444 style=font-family:verdana,tahoma;font-size:7pt><?=$hit?></td>
</tr>
<tr><td colspan=6 bgcolor=#D4D4D4><img src=images/dot.gif height=1></td></tr>
