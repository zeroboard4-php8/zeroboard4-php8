...
<tr align=center onMouseOver=this.style.backgroundColor="#F9F9F9" onMouseOut=this.style.backgroundColor="">
  <td nowrap><font color=444444 style=font-family:tahoma;font-size:7pt><?=$number?></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'>&nbsp; <?=$insert?><?=$icon?><?=$subject?>&nbsp;<font color=444444 style=font-family:tahoma;font-size:7pt><?=$comment_num?></font></td>
  <td nowrap><font color=444444 style=font-family:tahoma;font-size:9pt><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap><font color=444444 style=font-family:tahoma;font-size:7pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=444444 style=font-family:tahoma;font-size:7pt><?=$hit?></td>
</tr>
<tr><td height=1 colspan=6 background=<?=$dir?>/dot2.gif><img src=<?=$dir?>/dot2.gif border=0 height=1></td></tr>
