...
/* Check New Comment <?=$comment_new?> */
  ...
  elseif(time()-$last_comment_time<60*60*24) $comment_new = "<font color=gray size=1 style=\"cursor:hand\" title=\"".cut_str(stripslashes($last_comment['memo']),30)."\">*</font>";
  else $comment_new = "";
 ?>
...
<tr align=center bgcolor=#ffffff onmouseover="this.style.backgroundColor='#F9F9F9'" onmouseout="this.style.backgroundColor='#ffffff'">
  <td height=22 class=pqbig-ver7list><?=$number?></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;' class=pqbig-thm9><img src=images/t.gif height=3><br><?=$insert?><?=$icon?><?=$subject?> <font style=font-family:Tahoma;font-size:7pt;><?=$comment_num?> <?=$comment_new?></font></td> 
  <td style='word-break:break-all;' class=pqbig-thm9><img src=images/t.gif height=3><br><?=$face_image?> <?=$name?></div></td>
  <td class=pqbig-ver7list><?=$reg_date?></td>
  <td class=pqbig-ver7list><?=$hit?></td>
</tr>
