...
<tr align=center bgcolor=#F9F9F9>
  <td height=22><img src=<?=$dir?>/notice_head_2.gif border=0></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;' class=pqbig-thm9><img src=images/t.gif height=3><br><?=$insert?><?=$icon?><?=$subject?> <font style=font-family:Tahoma;font-size:6pt;font-weight:bold;letter-spacing:-1px;><?=$comment_num?></font></td> 
...
<tr><td colspan=10 height=1 class=pqbig-line1><img src=/images/t.gif height=1></td></tr>
