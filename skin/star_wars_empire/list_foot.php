...
<tr>
 <td width=40% height=20 nowrap> 
  ...
  <?=$a_1_prev_page?><img src=<?=$dir?>/images/btn_prev.gif border=0 align=absmiddle></a>  
  <?=$a_1_next_page?><img src=<?=$dir?>/images/btn_next.gif border=0 align=absmiddle></a>
</td>
...
<tr>
 <td colspan=2 align=center>
   ...
   <img src=<?=$dir?>/images/search_left.gif align=absmiddle><input type=text name=keyword value="<?=$keyword?>" <?=size(15)?> class=input style=font-size:8pt;font-family:Arial;vertical-align:top;border-left-color:#000000;border-right-color:#000000;border-top-color:<?=$sC_search0?>;border-bottom-color:<?=$sC_search0?>;height:18px;><input type=image border=0 align=absmiddle src=<?=$dir?>/images/search_right.gif><?=$a_cancel?><img src=<?=$dir?>/images/search_right2.gif align=absmiddle border=0></a>
 </td>
</form>
</tr>
