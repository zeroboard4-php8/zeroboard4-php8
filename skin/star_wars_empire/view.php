...
<?php /// 화면상단 정보표시 끌 ///?>
  ...
  <tr align=center>
   <td width=150><table width=150 border=0 cellspacing=0 cellpadding=0><tr><td><img src=<?=$dir?>/images/view2.gif></td></tr></table></td>
   <td width=100% colspan=2>
   <table width=100% height=18 border=0 cellspacing=0 cellpadding=0 background=<?=$dir?>/images/bg.gif>
  <tr>
    <td width=10 height=18><img src=<?=$dir?>/images/view5.gif></td>
    <td width=100% height=18 style=font-family:Matchworks,Tahoma;font-size:8pt;color:#FFFFFF align=right nowrap><img src=<?=$dir?>/images/logo.gif></td>
  </tr>
</table>
</td>
</tr>
...
<table border=0 cellspacing=0 cellpadding=0 width=<?=$width?>>
<tr>
 <td style='word-break:break-all;padding:10px;' bgcolor=#000000 height=100 valign=top>
