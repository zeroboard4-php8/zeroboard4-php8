...
<table width=600 height=16 border=0 cellspacing=0 cellpadding=0>
  <tr>
    <td width=100 border=0 cellspacing=0 cellpadding=0><img src=<?=$dir?>/images/write1.gif></td><td></td>
  </tr>
</table>
<table width=600 height=16 border=0 cellspacing=0 cellpadding=0>
  <tr>
    <td width=100><table width=100 border=0 cellspacing=0 cellpadding=0><tr><td><img src=<?=$dir?>/images/write2.gif></td></tr></table></td>
    <td width=100% background=<?=$dir?>/images/bg.gif style=font-family:Matchworks,Tahoma;font-size:8pt;color:#FFFFFF align=right nowrap><img src=<?=$dir?>/images/logo.gif></td>
  </tr>
</table>

<?php 
  if($mode=="reply") $title="write3a.gif";
  elseif($mode=="modify") $title="write3b.gif";
  else $title="write3c.gif";
?>
<table border=0 cellspacing=0 cellpadding=0 width=600>
<tr>
  <td colspan=2 height=35><img src=<?=$dir?>/images/<?=$title?>></td>
</tr>
...
<tr><td bgcolor=#000000 height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
