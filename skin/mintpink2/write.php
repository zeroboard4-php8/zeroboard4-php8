...
<?php
  if($mode=="reply") $title="<span style=font-family:Arial;font-size:8pt;font-weight:bold;><font color=#FF7FBF>Post a </font> <span style=font-size:15px;letter-spacing:-1px;>Reply</span></span>";
  elseif($mode=="modify") $title="<span style=font-family:Arial;font-size:8pt;font-weight:bold;><font color=#FF7FBF>Modify</font> <span style=font-size:15px;letter-spacing:-1px;>Article</span></span>";
  else $title="<span style=font-family:Arial;font-size:8pt;font-weight:bold;><font color=#FF7FBF>Post a </font> <span style=font-size:15px;letter-spacing:-1px;>New Article</span></span>";
?>
...
<table border=0 width=100% cellspacing=1 cellpadding=0 bgcolor="white">
...
<tr>
  ...
  <td> <input type=text name=subject value="<?=$subject?>" <?=size(50)?> maxlength=200 class=input> </td>
</tr>
<tr><td bgcolor=#FFffff height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr>
  <td align=right class=thm8><b>Contents&nbsp;</b></td>
  <td valign=top>
  <textarea name=memo <?=size2(48)?> rows=15 class=textarea><?=$memo?></textarea>
  </td>
</tr>
...
<tr height=25>
  ...
  <td> <input type=text name=sitelink1 value="<?=$sitelink1?>" <?=size(50)?> maxlength=200 class=input> </td>
</tr>
<?=$hide_sitelink1_end?>
