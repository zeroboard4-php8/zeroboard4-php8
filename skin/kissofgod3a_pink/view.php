...
<tr>
  <td height=23 nowrap style='padding:10 0 15 10'><?=$face_image?> <?=$name?>&nbsp;<?php if($data['email']) { ?> <font style=font-size:7pt;font-family:Tahoma;font-weight:normal>[<a href=mailto:<?=$data['email']?>><?=$data['email']?></a>]</font><?php } ?><font style='font-weight:normal'>님<?=$hide_homepage_start?> ( <?=$a_homepage?><img src=<?=$dir?>/icon_homepage.gif border=0></a> ) <?=$hide_homepage_end?>께서 남기신 글입니다.</font>
  </td>
