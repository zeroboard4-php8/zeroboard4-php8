<?php 
// 그림창고
	$bt_imgbox = '<b>'.$a_imagebox.'<img src='.$_lang_dir.'bt_imgbox.gif border=0 align=absmiddle></a></b>';

// 미리보기
	$bt_preview = '<b>'.$a_preview.'<img src='.$_lang_dir.'bt_preview.gif border=0 align=absmiddle></a></b>&nbsp;&nbsp;';
...
//---- text ----------------------------------
	...
	$_strSkin['write_ok']	= $_lang_dir.'bt_write_ok.gif';
	$_strSkin['cancel']		= $_lang_dir.'bt_cancel.gif';
