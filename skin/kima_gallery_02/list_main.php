...
<td width=<?php echo (100 / $max_show_image);?>% valign=top align=center style='padding:15 5 0 5;'>
   ...
   <td>
       ...
       <tr>
       <td align=center style='padding:5;' class=input><?=$view_img?><img src=<?=$img_name?> width=<?=$img_w?>  height=<?=$img_h?> border=0></a></td>
       </tr>
       <tr>
       <td width=<?=$img_w?> style='padding-top:5;' align=center><?=$subject?><?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data['no']?>"><?=$hide_cart_end?></td>
       </tr>
       </table>
   </td>
   </tr>
