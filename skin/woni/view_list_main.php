...
///////////////////////////////////////////////////////////////////////// ?>
<!-- 목록 부분 시작 -->
<tr><td height=5 colspan=0><img src=images/t.gif width=1 height=1></td></tr> 
<tr align=center>
  <td nowrap class=thm8><font color=0D4963 style=font-family:민9;font-size:9pt><?=$number?></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;' class=thm8>&nbsp; <?=$insert?><?=$icon?><?=$subject?> <font style=font-family:민9;font-size:9pt><?=$comment_num?></font></td> 
  <td nowrap class=thm8><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap class=thm8><font color=457387 style=font-family:민9;font-size:9pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap class=thm8><font color=457387 style=font-family:민9;font-size:9pt><?=$hit?></td>
</tr>
<tr><td height=5 colspan=6><img src=images/t.gif width=1 height=1></td></tr>
