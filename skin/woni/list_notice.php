...
<tr align=center bgcolor=F2F8FA><td height=5 colspan=6><img src=images/t.gif width=1 height=1></td></tr>
<tr align=center bgcolor=F2F8FA>
  <td nowrap class=thm8><font color=457387 style=font-family:민9;font-size:9pt>NOTICE</td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'>&nbsp; <?=$insert?><?=$subject?> <font style=font-family:민9;font-size:9pt><?=$comment_num?></font></td> 
  <td nowrap><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap><font color=457387 style=font-family:민9;font-size:9pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=457387 style=font-family:민9;font-size:9pt><?=$hit?></td>
</tr>
