...
<!-- 마무리 부분입니다 -->
<tr><td colspan=10 height=1><img src=images/t.gif border=0 width=1 height=1></td></tr>
</table>

<!-- 버튼 부분 -->
<table border=0 align=center cellspacing=1 cellpadding=1 width=<?=$width?>>
<tr>
	...
	<td width=40% height=20 nowrap> 
					...
					<td align=center colspan=2 class=page nowrap>
						<font class=t><?=$a_prev_page?>[prev]</a> <?=$print_page?> <?=$a_next_page?>[next]</a></font>
					</td>
...
<tr>
  ...
  <tr>
     ...
     <td style='padding:0 0 0 3'><input type=text name=keyword value="<?=$keyword?>" class=search size=15></td>
     <td valign=bottom><input type=image src=<?=$dir?>/search.gif border=0 onfocus=blur() title='검색어를 입력하셨으면 누르세요.'></td>
     <td valign=bottom><?=$a_cancel?><img src=<?=$dir?>/cancel.gif border=0 title='게시판 목록으로 되돌아갑니다.'></a></td>
  </tr>
  </table>
