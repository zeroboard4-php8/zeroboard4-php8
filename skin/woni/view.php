...
<tr><td height=5 colspan=3><img src=images/t.gif width=1 height=1></td></tr>
</table>
...
<tr>
<tr><td colspan=2 background=<?=$dir?>/dot.gif height=1><img src=<?=$dir?>/dot.gif border=0 height=1></td></tr>
 <td colspan=2 style='word-break:break-all;padding:10' height=80 >
     ...
     <?=$memo?>
     <br>
     <div align=right style=font-family:민9;font-size=9pt><?=$ip?></div>
     </span>
 </td>
</tr>
</table>
