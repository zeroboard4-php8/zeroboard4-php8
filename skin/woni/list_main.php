...
<tr align=center onMouseOver=this.style.backgroundColor='#F8FCFC' onMouseOut=this.style.backgroundColor=''>
  <td nowrap class=thm8><font color=457387 style=font-family:민9;font-size:9pt><?=$number?></td>
