...
<col width=70></col><col width=8></col><col width=></col><col width=40></col>
<tr valign=top>
	<td>
...
<td align=right><font class=list_eng><span title='<?=date("Y-m-d",$c_data['reg_date'])?>  <?=date("H:i:s",$c_data['reg_date'])?>'><?=date("m-d",$c_data['reg_date'])?></span></font> &nbsp;<?=$a_del?><font class=list_eng2>DEL</font></a></td>
</tr>
</table>
<img src=/images/t.gif border=0 height=8><br>
