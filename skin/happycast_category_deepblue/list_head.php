...
<col width=30></col><?=$hide_cart_start?><col width=20></col><?=$hide_cart_end?><col width=></col><col width=100></col><col width=80></col><col width=30></col><col width=20></col>
<tr align=center>
...
<?=$hide_cart_end?>
   ...
   <td <?php if(!$browser)echo"width=90%";?>>
      <table width=100% border=1 cellspacing=0 cellpadding=0 bgcolor=<?=$list_header_bg_color?> bordercolorlight=<?=$list_header_dark0?> bordercolordark=<?=$list_header_dark1?>>
      <tr>
