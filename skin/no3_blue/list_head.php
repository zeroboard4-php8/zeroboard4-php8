...
<table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor=#7BD3F0> 
<tr align=center>
...
<?=$hide_cart_start?>
  <td><table border=0 cellspacing=0 cellpadding=0 background=<?=$dir?>/h_bg.gif width=100%><tr>
      <td align=center><?=$a_cart?><img src=<?=$dir?>/h_c.gif border=0></a></td>
      </tr></table>
  </td>
<?=$hide_cart_end?>
