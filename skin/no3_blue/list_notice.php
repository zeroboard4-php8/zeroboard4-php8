...
<tr align=center  bgcolor="#38b0d8" onMouseOver=this.style.backgroundColor="#1888b0" onMouseOut=this.style.backgroundColor="#38b0d8">
  <td nowrap><img src=<?=$dir?>/nono.gif border=0></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  ...
  <td nowrap><font color=ffffff style=font-family:tahoma;font-size:7pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=ffffff style=font-family:tahoma;font-size:7pt><?=$hit?></td>
</tr>
<tr><td colspan=6 background=<?=$dir?>/dot2.gif><img src=images/dot.gif height=1></td></tr>
