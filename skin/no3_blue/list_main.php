...
///////////////////////////////////////////////////////////////////////// ?>
<!-- 목록 부분 시작 -->
<tr align=center bgcolor=7bd3f0 onMouseOver=this.style.backgroundColor="#a2ddf0" onMouseOut=this.style.backgroundColor="7bd3f0">
  <td nowrap><font color=666666 style=font-family:tahoma;font-size:7pt><?=$number?></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'>&nbsp; <?=$insert?><?=$icon?><?=$subject?>&nbsp;<font color=white style=font-family:tahoma;font-size:7pt><?=$comment_num?></font></td>
  <td nowrap><font class=blue><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap><font class=blue2>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font class=blue2><?=$hit?></td>
</tr>
<tr><td height=1 colspan=6 bgcolor=#178bb0></td></tr>
