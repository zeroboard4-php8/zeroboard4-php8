...
///////////////////////////////////////////////////////////////////////////// ?>
<?php $memo = str_replace("<table border=0 cellspacing=0 cellpadding=0 width=100% style=\"table-layout:fixed;\"><col width=100%></col><tr><td valign=top>","<table border=0 cellspacing=0 cellpadding=0 width=100% style=\"table-layout:fixed;\"><col width=100%></col><tr><td valign=top class=view_bg>",$memo); ?>
<?php $memo = str_replace("</table>","</tr></td></table>",$memo); ?>
...
<tr>
 ...
 <td background=<?=$dir?>/h_bg.gif width=100%><img src=<?=$dir?>/view.gif border=0></td>
 <td><img src=<?=$dir?>/h_right.gif border=0></td>
</tr>
</table>
<table border=0 cellspacing=0 cellpadding=0 width=<?=$width?> class=view_bg>
<tr>
 <td align=right><font class=blue>이 름 :&nbsp</font></td>
 <td align=left width=90%><?=$face_image?> <?=$name?></td>
</tr>

<tr><td height=1 colspan=6></td>

<?=$hide_homepage_start?>
<tr>
 <td align=right ><font class=blue>홈 피 :&nbsp</font></td>
 <td ><?=$homepage?></td>
</tr>
<tr><td height=1 colspan=6></td>
<?=$hide_homepage_end?>
...
<tr>
 <td align=right ><font class=blue>파 일 :&nbsp</font></td>
...
<tr>
 <td align=right ><font class=blue>링 크 :&nbsp</font></td>
 <td ><?=$sitelink1?></td>
</tr>
<tr><td height=1 colspan=6></td>
<?=$hide_sitelink1_end?>
...
<tr>
 <td align=right style='word-break:break-all;'><font class=blue>제 목 :&nbsp</font></td>
...
<tr>
 <td colspan=2 style='padding:10' height=80>
	<center>
	<table border=0 cellspacing=0 cellpadding=0 width=90% class=view_bg>
	<tr>
	<td>
     <?=$upload_image1?>
     <?=$upload_image2?>
     <?=$memo?>
     <br>
     <div align=right><font class=blue2><?=$ip?></font></div>
	 <br>
	</td>
	</tr>
	</table>
...
<!-- 간단한 답글 시작하는 부분 -->
<?=$hide_comment_start?>
<table border=0 cellspacing=0 cellpadding=2 width=<?=$width?> style=background-color:#3bb0d6;>
	<tr><td colspan=4><center>C o m m e n t &nbsp C o l l e c t i o n</center></td></tr>
