<?php 
@zb_query("update zetyx_admin_table  set only_board=''  where name='$id'"); 
@zb_query("update zetyx_admin_table  set use_pds=''  where name='$id'"); 
@zb_query("update zetyx_admin_table  set use_homelink=''  where name='$id'"); 
@zb_query("update zetyx_admin_table  set use_filelink=''  where name='$id'"); 
?> 
...
<table border=0 cellspacing=0 cellpadding=0 width=<?=$width?>  style='border-width:0 0 1 0;border-color:#F3F3F3;border-style:solid;'>
<?=$memo_on_sound?>
