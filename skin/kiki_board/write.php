...
<tr height=25>
 <td colspan=2>
  ...
  <td width=80 align=right class=thm8><img src=<?=$dir?>/p.w.gif ></td>
  <td>
...
<tr height=25>
  <td align=right class=thm8><img src=<?=$dir?>/mail.gif ></td>
...
<tr height=25>
  <td align=right class=thm8 width=80><img src=<?=$dir?>/special.gif ></td>
  <td>
  <table border=0 cellpadding=0 cellspacing=0>
  <tr>
  <td>
<?=$category_kind?>
  ...
  <td>
       <?=$hide_notice_start?> <input type=checkbox name=notice <?=$notice?> value=1></td><td class=thm8>&nbsp;공지 &nbsp;&nbsp;<?=$hide_notice_end?></td>
  <td>
       <?=$hide_html_start?> <input type=checkbox name=use_html <?=$use_html?> value=1></td><td class=thm8>&nbsp;Html사용 &nbsp;&nbsp;<?=$hide_html_end?></td>
  <td>     <input type=checkbox name=reply_mail <?=$reply_mail?> value=1></td><td class=thm8>&nbsp;답변메일받기&nbsp;&nbsp;</td>
  <td>    <?=$hide_secret_start?> <input type=checkbox name=is_secret <?=$secret?> value=1></td><td class=thm8>&nbsp;비밀글&nbsp;&nbsp;<?=$hide_secret_end?></td>
  </tr>
  </table>
  </td>
</tr>
...
<tr height=25>
  <td align=right class=thm8><img src=<?=$dir?>/link1.gif ></td>
...
<tr height=25>
  <td>&nbsp;</td>
  <td class=thm8>파일 업로드는 <?=$upload_limit?> 까지 사용하실수 있습니다.</td>
</tr>

<tr height=25>
  <td align=right class=thm8><img src=<?=$dir?>/upload.gif ></td>
  <td> <input type=file name=file1 <?=size(50)?> maxlength=255 class=input> <?=$file_name1?></td>
</tr>

<tr height=25>
  <td align=right class=thm8><img src=<?=$dir?>/upload1.gif ></td>
...
<tr align=center height=30>
  <td align=center>
      ...
      <img src=<?=$dir?>/list.gif align=absmiddle border=0 style=cursor:hand onclick=history.back()>
  </td>
</tr>
</table>
