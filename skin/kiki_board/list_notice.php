...
<tr align=center bgcolor='#e6e6e6' onMouseOver=this.style.backgroundColor='#e6e6e6' onMouseOut=this.style.backgroundColor=''>
  <td height=20 align=center>
    <img src=<?=$dir?>/notice.gif border=0></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  ...
  <td class=tahoma><?=$reg_date?></td>
  <td class=tahoma><?=$hit?></td>
</tr>
  <tr>
