...
<col width=></col>
<tr>
 <td colspan="2" style='word-break:break-all;' height=50 class=textarea>&nbsp;&nbsp;<?=$name?> :: <i>&nbsp;<font class=sub><?=$subject?></font></i></td>
</tr>
...
<tr><td width=8 background=<?=$dir?>/i.gif></td>
  <td colspan=2>
...
<?=$upload_image2?>
    ...
    <table border=0 width=100% cellspacing=5 cellpadding=2 align=top >
    <tr>
     <td><?=$memo?></td>
    </tr>
    </table>
