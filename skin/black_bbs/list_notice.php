...
<tr align=center height=35 onMouseOver=this.style.backgroundColor='202020' onMouseOut=this.style.backgroundColor=''>

  <?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
<td>√</td>

 <?=$hide_category_start?><td align=center >-</td><?=$hide_category_end?>

  <td align=left style='word-break:break-all;'><font class=sub><i><?=$subject?></i> </font><font class=n color=d6bf03><?php
