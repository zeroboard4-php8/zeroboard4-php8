...
<!-- 목록 부분 시작 -->
	...
	<tr height=30 align=center bgcolor="#F8F5F2">
		<td nowrap></td>
		<?=$hide_cart_start?>
		...
		<?=$hide_category_end?>
		<td align=left style='word-break:break-all;'><img height=2><br><?=$insert?><?=$icon?><b><?=$subject?></b> <span class="comment_number"><?=$comment_num?></span></td> 
		<td nowrap><img height=3><br><?=$face_image?>&nbsp;<?=$name?>&nbsp;</td>
