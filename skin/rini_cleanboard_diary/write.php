...
<tr height=22>
  ...
  <td><input type=text name=subject value="<?=$subject?>" <?=size(60)?> maxlength=200 class=rini_input style="width:320;height:18;">
  </td>
</tr>
...
<tr height=22>
  <td width=70 align=right><font class=rini_ver>link 1</font>&nbsp;&nbsp;&nbsp;</td>
  <td><input type=text name=sitelink1 value="<?=$sitelink1?>" <?=size(60)?> maxlength=200 class=rini_input style="width:320;height:18;">
  </td>
</tr>
<?=$hide_sitelink1_end?>
...
<tr height=22>
  <td width=70 align=right><font class=rini_ver>file 1</font>&nbsp;&nbsp;&nbsp;</td>
  <td><input type=file name=file1 <?=size(50)?> maxlength=255 class=rini_input style="width:320;height:18;"> <?=$file_name1?>
  </td>
</tr>

<tr height=22>
  <td width=70 align=right><font class=rini_ver>file 2</font>&nbsp;&nbsp;&nbsp;</td>
  <td><input type=file name=file2 <?=size(50)?> maxlength=255 class=rini_input style="width:320;height:18;"> <?=$file_name2?>
  </td>
</tr>
<?=$hide_pds_end?>
