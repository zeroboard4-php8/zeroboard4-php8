...
<td bgcolor=#F3F3F3>
 ...
 <tr>
  <td class=write>Name</td>
  <td class=write>Memo</td>
<?=$hide_c_password_start?>
  <td class=write>Password</td>
<?=$hide_c_password_end?>
  <td>&nbsp;</td>
 </tr>
 <tr>
...
<?=$hide_c_password_end?>
  <td><input type=submit style=font-family:Matchworks,Tahoma;font-size:8pt; class=submit class=height:18px value='Comment'></td>
  </tr>
  </table>
</td></tr></table><br>
