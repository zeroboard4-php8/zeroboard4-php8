...
<?=$hide_prev_start?>
<tr><td colspan=5 height=1 class=line1 style=height:1px><img src=<?=$dir?>/t.gif border=0 height=1></td></tr>
<tr height=23>
<td></td>
<td><span class=icon>&nbsp;PREV ：</span></td>
<td><span class=list_han>&nbsp;<?=$prev_icon?><?=$a_prev?><?=$prev_subject?></a></span></td>
<td align=right><span class=list han><?=$prev_name?>&nbsp;</span></td>
<td></td>
</tr>
<?=$hide_prev_end?>
...
<td align=right><span class=list_han><?=$next_name?>&nbsp;</span></td>
<td></td>
</tr>
