...
<tr>
  ...
  <td>
    ...
    <?=$a_delete_all?><img src=<?=$dir?>/btn_deleteall.gif border=0 align=absmiddle></a>
...
<tr>
  ...
  <tr>
     ...
     <td style="filter: Alpha(Opacity=60)"><input type=text name=keyword value="<?=$keyword?>" class=input size=19></td>
