...
<tr><td align=center height=10 style="padding:1px 1px 0 1px; word-wrap:break-word; word-break:break-all;"><font class=bat6><?=$date=date("Y · m · d",$data['reg_date'])?></font></td></tr>
<tr><td align=center height=10 style="padding:1px 1px 0 1px; word-wrap:break-word; word-break:break-all;"><font class=bat6><?=$a_modify?>M</a>&nbsp;<font color=#b2b2b2>&nbsp;&nbsp;&nbsp;</font>&nbsp;<font class=bat6><?=$a_delete?>D</a>&nbsp;</td></tr>
